...
pub fn main() {
    ...
    sphere.set_transformation(Mat4::from_translation(vec3(0.0, 2.3, 3.0)) * Mat4::from_scale(0.2));
    ...
    cube.set_transformation(Mat4::from_translation(vec3(1.0, 0.0, 1.0)) * Mat4::from_scale(0.2));
    ...
    window
        .render_loop(move |mut frame_input: FrameInput| {
            ...
            camera
                .rotate_around(&vec3(0.0, 1.0, 1.0), 0.01, 0.02)
                .expect("rotate_around failed");
            control
